...
internal class TicketService : ITicketService
{
    ...
    public TicketService(IClock clock, IConferenceRepository conferenceRepository, ITicketRepository ticketRepository,
        ITicketSaleRepository ticketSaleRepository, ITicketGenerator ticketGenerator, IMessageBroker messageBroker,
    ...
    public async Task PurchaseAsync(Guid conferenceId, Guid userId)
    {
        ...
        ticket = _ticketGenerator.Generate(conferenceId, ticketSale.Id, ticketSale.Price);
